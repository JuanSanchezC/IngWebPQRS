...
START TRANSACTION;
USE `pqrsdb`;
INSERT INTO `pqrsdb`.`solicitud` (`id`, `fechaCreacion`, `descripcion`, `correo`, `factura`, `filial`, `empleadoAsignado`, `tipoSolicitud`, `respuesta`, `fechaRespuesta`, `satisfaccion`, `fechaAsignacion`, `motivo`) VALUES (1, '2017-05-04 16:01:50', 'Me siento estafado', 'usuario1@algo.com', 1, 1, 1, 4, NULL, NULL, '0', '2017-05-04 16:01:50', 1);
INSERT INTO `pqrsdb`.`solicitud` (`id`, `fechaCreacion`, `descripcion`, `correo`, `factura`, `filial`, `empleadoAsignado`, `tipoSolicitud`, `respuesta`, `fechaRespuesta`, `satisfaccion`, `fechaAsignacion`, `motivo`) VALUES (2, '2017-05-04 17:01:50', 'Que falta de Respeto!!', 'usuario2@algo.com', NULL, 2, 1, 2, NULL, NULL, '0', '2017-05-04 17:01:50', 2);
